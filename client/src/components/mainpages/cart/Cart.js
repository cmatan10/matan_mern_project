...
<div>
    ...
    <div className="total" style={{position:'sticky'}}>
                <h3>Total: $ {total}</h3>
                <button class="w3-border w3-round w3-green w3-medium"><Link to="/OrderContinue">complete your order</Link></button> 
            </div>
       </div>
        <div className="products">
           {
                cart.map(product => (
                    <Card className="product_card" sx={{ minHeight: 355, maxWidth: 355 , marginTop:2}} key={product._id}>
